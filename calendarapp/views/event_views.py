...
class EventModalCreateView(bsmfg.BSModalCreateView):
    ...
    def form_valid(self, form):
        ...
        self.object.user = self.request.user # Gets the user from the request and sets it as the object.user
    ...
    def get_context_data(self, **kwargs):
        ...
        categories = serializers.serialize("json", EventCategory.objects.get_categories()) # serialize as json so JS can unpack it
...
class EventDetailsModalUpdateView(bsmfg.BSModalUpdateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        now = datetime.now() # Used in templates to determine if an event is past or future
