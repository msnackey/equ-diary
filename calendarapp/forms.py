...
from calendarapp.models import Event, EventCategory, Exercise
...
class EventModalForm(BSModalModelForm):
    ...
    class Meta:
        ...
        fields = [
            ...
            "end_time",
            "planned_exertion",
        ]  # Only selects the relevant fields for creating a new event
    ...
    class Meta:
        ...
        widgets = {
            ...
            "post_fb_neg": forms.Textarea(
                attrs={
                    "class": "form-control",
                    "placeholder": "Enter attention points",
                },
            ),
...
class ExerciseModalForm(BSModalModelForm):
    class Meta:
        model = Exercise

        # Only selects the relevant fields for creating a new event
        fields = ["event", "category", "reps", "duration"]
        # Adding custom widgets for each field, i.e. to add CSS classes
        widgets = {
            "event": forms.Select(
                attrs={"class": "form-control"},
